...
public class TestGoalWriter {
    ...
    private <T extends I_TimestampedValue> void testGoalCreation(GoalPolarity goalPolarity, GoalType expectedGoalType,
                                                                 I_GoalRegistryUpdater<T> goalRegistryUpdater, GoalUnit goalUnit) {
        ...
        patient_.createGoal(randomName, randomDescription, goalPolarity, goalUnit);

        verify(goalRegistryUpdater, times(1)).addGoal(expectedGoalData);
    }

    private void testGoalIdOutput(I_GoalRegistryUpdater<?> goalRegistryUpdater, GoalUnit goalUnit) {
        RandomString stringGen = new RandomString();
        String randomName = stringGen.generate();
        String randomDescription = stringGen.generate();
        ...
        Long actualGoalId = patient_.createGoal(randomName, randomDescription, randomGoalPolarity, goalUnit);
    ...
    public void willCreateMassGoal(GoalPolarity goalPolarity, GoalType expectedGoalType) {
        testGoalCreation(goalPolarity, expectedGoalType, mockMassGoalRegistryUpdater_, GoalUnit.MASS);
    }

    @Test
    public void willReturnCorrectGoalIdWhenCreatingMassGoal() {
        testGoalIdOutput(mockMassGoalRegistryUpdater_, GoalUnit.MASS);
    }

    @ParameterizedTest
    @MethodSource("goalPolarityToGoalTypeMapping")
    public void willCreateDistanceGoal(GoalPolarity goalPolarity, GoalType expectedGoalType) {
        testGoalCreation(goalPolarity, expectedGoalType, mockDistanceGoalRegistryUpdater_, GoalUnit.DISTANCE);
    }

    @Test
    public void willReturnCorrectGoalIdWhenCreatingDistanceGoal() {
        testGoalIdOutput(mockDistanceGoalRegistryUpdater_, GoalUnit.DISTANCE);
    }

    @ParameterizedTest
    @MethodSource("goalPolarityToGoalTypeMapping")
    public void willCreateDurationGoal(GoalPolarity goalPolarity, GoalType expectedGoalType) {
        testGoalCreation(goalPolarity, expectedGoalType, mockDurationGoalRegistryUpdater_, GoalUnit.DURATION);
    }

    @Test
    public void willReturnCorrectGoalIdWhenCreatingDurationGoal() {
        testGoalIdOutput(mockDurationGoalRegistryUpdater_, GoalUnit.DURATION);
    }

    @ParameterizedTest
    @MethodSource("goalPolarityToGoalTypeMapping")
    public void willCreateVelocityGoal(GoalPolarity goalPolarity, GoalType expectedGoalType) {
        testGoalCreation(goalPolarity, expectedGoalType, mockVelocityGoalRegistryUpdater_, GoalUnit.VELOCITY);
    }

    @Test
    public void willReturnCorrectGoalIdWhenCreatingVelocityGoal() {
        testGoalIdOutput(mockVelocityGoalRegistryUpdater_, GoalUnit.VELOCITY);
    }

    @ParameterizedTest
    @MethodSource("goalPolarityToGoalTypeMapping")
    public void willCreateCustomGoal(GoalPolarity goalPolarity, GoalType expectedGoalType) {
        testGoalCreation(goalPolarity, expectedGoalType, mockCustomGoalRegistryUpdater_, GoalUnit.CUSTOM);
    }

    @Test
    public void willReturnCorrectGoalIdWhenCreatingCustomGoal() {
        testGoalIdOutput(mockCustomGoalRegistryUpdater_, GoalUnit.CUSTOM);
    }
